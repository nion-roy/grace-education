<div class="card mb-3">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <div class="d-block">
                <label for="frontend_logo_menu">
                    <img src="<?php echo e(asset(get_setting('frontend_logo_menu', $demoImg))); ?>"
        ...
        <div class="form-group">
            ...
            <div class="d-block">
                <label for="frontend_logo_footer">
                    <img src="<?php echo e(asset(get_setting('frontend_logo_footer', $demoImg))); ?>"
                        class="border img-fluid rounded holder" alt="Image upload">
                </label>
            </div>
        </div> <!-- form-group-->
        ...
        <div class="form-group">
            ...
            <div class="d-block">
                <label for="admin_logo">
                    <img src="<?php echo e(asset(get_setting('admin_logo', $demoImg))); ?>" class="border img-fluid rounded holder"
                        alt="Image upload">
                </label>
            </div> <!-- col-->
        </div> <!-- form-group-->
        ...
        <div class="form-group">
            ...
            <div class="d-block">
                <label for="favicon">
                    <img src="<?php echo e(asset(get_setting('favicon', $demoImg))); ?>" class="border img-fluid rounded holder"
                        alt="Image upload">
                </label>
            </div> <!-- col-->
        </div> <!-- form-group-->
        ...
        <div class="form-group">
            <?php echo e(html()->label('Affiliate Logo')->for('affiliate_logo')); ?>

            <?php echo e(html()->file('affiliate_logo')->class('form-control-file image d-none')->id('affiliate_logo')->acceptImage()); ?>

            <div class="d-block">
                <label for="affiliate_logo">
                    <img src="<?php echo e(asset(get_setting('affiliate_logo', $demoImg))); ?>"
                        class="border img-fluid rounded holder" alt="Image upload">
                </label>
            </div> <!-- col-->
        </div> <!-- form-group-->
...
<?php /**PATH D:\php 7.4\htdocs\student\student\resources\views/backend/content/settings/general/includes/logoSetting.blade.php ENDPATH**/ ?>