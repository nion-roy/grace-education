<div class="card">
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <?php echo e(html()->label('Result Section Background Image')->for('volunteer_bg_image')); ?>
                        ...
                        <div class="d-block">
                            <label for="volunteer_bg_image">
                                <img src="<?php echo e(asset(get_setting('volunteer_bg_image', $demoImg))); ?>" class="border img-fluid rounded holder" alt="Image upload">
                            </label>
                        </div>
                    </div> <!-- form-group-->
                </div>
    ...
    <!--  .card-body -->
</div> <!--  .card --><?php /**PATH D:\php 7.4\htdocs\student\student\resources\views/backend/content/settings/general/includes/homebackbg.blade.php ENDPATH**/ ?>